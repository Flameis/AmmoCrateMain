...
DefaultProperties
{
	...
	Items[RORIGM_Default]={(
					// Primary : DEFAULTS
					PrimaryWeapons=(class'ROGame.ROWeap_F1_SMG',ROWeap_Owen_SMG,class'ROGame.ROWeap_M37_Shotgun',class'ROGame.ROWeap_XM177E1_Carbine_Late',class'ROGame.ROWeap_M1A1_SMG'),
