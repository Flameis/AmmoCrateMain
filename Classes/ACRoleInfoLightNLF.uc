...
DefaultProperties
{
	...
	Items[RORIGM_Default]={(
					...
					OtherItems=(class'MutExtras.ACWeap_Molotov_Triad',class'MutExtras.ACWeap_Tripwire_Quad',class'MutExtras.ACWeap_FougQuad',class'ROGame.ROWeap_RDG1_Smoke',class'ROGame.ROItem_Binoculars'),
