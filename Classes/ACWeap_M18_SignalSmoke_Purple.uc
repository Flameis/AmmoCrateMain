...
//=============================================================================
class ACWeap_M18_SignalSmoke_Purple extends ROEggGrenadeWeapon
	abstract;
...
defaultproperties
{
	WeaponContentClass(0)="AmmoCrate.ACWeap_M18_SignalSmoke_Purple_Content"
	...
	AmmoClass=class'ACAmmo_M18_Smoke_Purple'

	// MAIN FIREMODE
	FiringStatesArray(0)=WeaponSingleFiring
	WeaponProjectiles(0)=class'M18SmokeProjectilePurple'
