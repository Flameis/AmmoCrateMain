...
defaultproperties
{
	...
	WeaponProjectiles(ALTERNATE_FIREMODE)=class'M79Buckshot'
	FireInterval(ALTERNATE_FIREMODE)=0.15
	DelayedRecoilTime(ALTERNATE_FIREMODE)=0.01
	Spread(ALTERNATE_FIREMODE)=0.045
	NumProjectiles(ALTERNATE_FIREMODE)=20
	...
	WeaponFireSnd(ALTERNATE_FIREMODE)=(DefaultCue=AkEvent'WW_WEP_M79.Play_WEP_M79_Buck_Fire_Single_3P',FirstPersonCue=AkEvent'WW_WEP_M79.Play_WEP_M79_Buck_Fire_Single')
}
