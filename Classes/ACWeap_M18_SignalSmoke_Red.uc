...
//=============================================================================
class ACWeap_M18_SignalSmoke_Red extends ROEggGrenadeWeapon
	abstract;
...
defaultproperties
{
	WeaponContentClass(0)="AmmoCrate.ACWeap_M18_SignalSmoke_Red_Content"
	...
	AmmoClass=class'ACAmmo_M18_Smoke_Red'

	// MAIN FIREMODE
	FiringStatesArray(0)=WeaponSingleFiring
	WeaponProjectiles(0)=class'ACM18SmokeProjectileRed'
