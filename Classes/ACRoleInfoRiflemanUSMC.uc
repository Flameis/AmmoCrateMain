...
defaultproperties
{
	...
	Items[RORIGM_Default]={(
					// Primary : DEFAULTS
					PrimaryWeapons=(class'ROGame.ROWeap_M14_Rifle',class'ROGame.ROWeap_M16A1_AssaultRifle',class'ROGame.ROWeap_XM177E1_Carbine',class'ROGame.ROWeap_M1Garand_Rifle'),
