//=============================================================================
// ROWeapAttach_MKb42_AssaultRifle_Level2
//=============================================================================
...
class ROWeapAttach_MKb42_AssaultRifle_Level2 extends ROWeapAttach_MKb42_AssaultRifle;

defaultproperties
{
	// SRS - Changed the weapon class reference since we cannot access a class in the content package
	// WeaponClass=class'ROWeap_MKb42_AssaultRifle_Level2'
