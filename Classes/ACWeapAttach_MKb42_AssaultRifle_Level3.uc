//=============================================================================
// ACWeapAttach_MKb42_AssaultRifle_Level3
//=============================================================================
...
class ACWeapAttach_MKb42_AssaultRifle_Level3 extends ACWeapAttach_MKb42_AssaultRifle_Level2;

defaultproperties
{
	// SRS - Changed the weapon class reference since we cannot access a class in the content package
	// WeaponClass=class'ACWeap_MKb42_AssaultRifle_Level3'
