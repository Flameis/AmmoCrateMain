...
//=============================================================================
class ACWeap_M18_SignalSmoke_Green extends ROEggGrenadeWeapon
	abstract;
...
defaultproperties
{
	WeaponContentClass(0)="AmmoCrate.ACWeap_M18_SignalSmoke_Green_Content"
	...
	AmmoClass=class'ACAmmo_M18_Smoke_Green'

	// MAIN FIREMODE
	FiringStatesArray(0)=WeaponSingleFiring
	WeaponProjectiles(0)=class'ACM18SmokeProjectileGreen'
	...
	WeaponProjectiles(ALTERNATE_FIREMODE)=class'ACM18SmokeProjectileGreen'
